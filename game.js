...
function setup() {
  ...
  bases = [
    { x: 350, y: 400 }, // Home Plate
    { x: 500, y: 300 }, // 1st Base
    { x: 350, y: 200 }, // 2nd Base
    { x: 200, y: 300 }  // 3rd Base
  ];

  // Pitcher & Batter
  pitcher = { x: 350, y: 250, armAngle: 0 };
  batter = { x: 350, y: 420, running: false, speed: 3, base: 0 };

  // Fielders
  fielders = [
    { x: 350, y: 150 }, { x: 450, y: 220 }, { x: 250, y: 220 },
    { x: 500, y: 350 }, { x: 200, y: 350 }
  ];
...
function draw() {
  ...
  // Apply zoom based on the current zoom state
  if (zoomState === 'batter') {
    zoomOnBatter();
